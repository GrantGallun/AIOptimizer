...
| adaptive attention context (opt-in) | strong semantic address → encoder-selected context; vague request → broad chronology; privacy-filtered and source-grounded | HYP-33: **+0.650** vs chronology under pressure; HYP-34: +0.100 on real transcript texture; HYP-42 (vs genuinely *untreated* baselines): **1.000 vs 0.000** against budget truncation at equal spend, and **parity at ~15% of the input tokens** against a full window that fits — i.e. a *quality* feature when context overflows, a *cost* feature when it doesn't (tested to ~6.4k tokens; no claim beyond) |
